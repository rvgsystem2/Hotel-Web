      ...
      <div class="card card-outline card-primary">
        ...
        <div class="card-body register-card-body">
          ...
          <form method="POST" action="{{ route('register') }}">
            ...
            <div class="input-group mb-1">
              <div class="form-floating">
                  <input id="registerPassword" name="password_confirmation" type="password" class="form-control" placeholder="" />
          ...
          <!-- /.social-auth-links -->
          <p class="mb-0">
            <a href="{{route('backend.login')}}" class="link-primary text-center"> I already have a member</a>
          </p>
        </div>
        <!-- /.register-card-body -->
      </div>
